  ...
  <div>
        ...
        <q-list>
          <q-item tag="label">
            ...
            <q-item-section>
              ...
              <q-item-label caption>Allows you to configure a trigger that will run once, hourly or minutely daily</q-item-label>
            </q-item-section>
          </q-item>
          <q-item tag="label">
            <q-item-section side top>
            ...
            <q-item-section>
              <q-item-label>Days per week</q-item-label>
              <q-item-label caption>Allows you to configure a trigger that will run once, hourly or minutely on certain days of the week</q-item-label>
            </q-item-section>
          </q-item>
          <q-item tag="label">
            <q-item-section side top>
            ...
            <q-item-section>
              <q-item-label>Days per month</q-item-label>
              <q-item-label caption>Allows you to configure a trigger that will run on a specific date of the month or specific day of the week</q-item-label>
            </q-item-section>
          </q-item>
          <q-item tag="label">
            <q-item-section side top>
            ...
            <q-item-section>
              <q-item-label>Cron expression</q-item-label>
              <q-item-label caption>Allows you to configure a trigger that will run according to the specific CRON expression</q-item-label>
            </q-item-section>
          </q-item>
        </q-list>
    ...
    <div class="row cell" v-if="model.schedule == 'monthly' || ((model.schedule == 'daily' || model.schedule == 'weekly') && model.interval=='once')">
      ...
      <div class="col-xs-12 col-sm-9 cell-content">
        ...
        Starting at
        <q-input filled v-model="model.startTime" class="inline">
          <template v-slot:append>
            <q-icon name="access_time" class="cursor-pointer">
              <q-popup-proxy transition-show="scale" transition-hide="scale">
                <q-time v-model="model.startTime" format24h ></q-time>
              </q-popup-proxy>
            </q-icon>
          </template>
        </q-input>
    ...
    <div class="row cell" v-if="model.schedule == 'cron'">
      ...
      <div class="col-xs-12 col-sm-9 cell-content">
        ...
        <q-input class="q-my-md" v-model="model.cron" placeholder="min hour day month weekday" label="Cron expression"/>
